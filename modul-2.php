                                                            ...
                                                            <div class="row align-items-center">
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="step-slide-box-caption">
                                                                        ...
                                                                        <ul>
                                                                            <li>Identifisere både helsemessige og prestasjonsmessige konsekvenser av REDs.</li>
                                                                            <li>Forklare hvordan REDs kan påvirke forskjellige kroppslige systemer på sikt </li>
                                                                            <li>Være klar over psykologiske konsekvenser</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
