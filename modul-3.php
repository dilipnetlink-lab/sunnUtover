                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                 ...
                                                                 <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <p>Symptomer er kroppens måte å si fra på. Å ta dem på alvor er viktig. </p>
                                                                        <p>I denne modulen skal vi gå gjennom diverse fysiske og psykiske symptomer på REDs. </p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <div class="bg-img-text-con">
                                                                        <div class="bg-img-text-full">
                                                                            ...
                                                                            <div class="bg-img-text-text">
                                                                                <p> <strong>Hvorfor er det viktig å forstå symptomene?</strong></p>
                                                                                <p>REDs kan utvikle seg gradvis uten at man merker det. Derfor er det viktig å være bevisst på hvilke parametere man bør følge med på jevnlig. På den måten: </p>
                                                                                <ul>
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                         <h3>Uforklarlig tretthet / lave energinivå</h3> 
                                                                 ...
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                                        <figure class="circle-img-box"><img src="images/box-modul-3-img-3.jpg"></figure>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <div class="bg-img-text-con">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Blir du ofte syk / tar det ofte lang tid å bli frisk?</h3> 
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Stagnasjon i trening - trener du mer enn du restituerer?</h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/> Ubalanse mellom trening, mat og hvile gjør at kroppen ikke klarer å restituere. Da uteblir både fremgang og prestasjon. Det kan også gjøre deg mer utsatt for skader.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="bg-img-text-con">
                                                                        <div class="bg-img-text-full">
                                                                            ...
                                                                            <div class="bg-img-text-text">
                                                                                <p> <strong>Tips - hva du kan følge med på:</strong></p>
                                                                                <ul>
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Sårbar for skader - opplever du småvondter eller tilbakevendende skader?</h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/> Vedvarende eller repeterende skader kan være et signal om at kroppen ikke får det den trenger for å tåle treningen. Tidlig innsikt kan forebygge alvorlige problemer.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="bg-img-text-con">
                                                                        <div class="bg-img-text-full">
                                                                            ...
                                                                            <div class="bg-img-text-text">
                                                                                <p> <strong>Tips og hva du kan følge med på:</strong></p>
                                                                                <ul>
                                                            ...
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/>Hormonforstyrrelser kan på lang sikt få konsekvenser for beinhelse og utvikling.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Kuldefølelse - fryser du lettere enn før? </h3> 
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Søvnproblemer - sliter du med å sovne eller sove gjennom natten? </h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/>Søvn er helt avgjørende for restitusjon, hormonbalanse og prestasjon. Uten god søvn klarer ikke kroppen å hente seg inn - og det kan forverre andre symptomer.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                            ...
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/>Jernmangel kan gi symptomer som ligner på vanlig tretthet – men har en helt annen årsak. Det bør tas på alvor og eventuelt følges opp med blodprøver.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Mage- og tarmplager - Oppblåst? Luft? Urolig mage?</h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/>Mageproblemer kan være en reaksjon på stress og underskudd. Når fordøyelsen går tregere, påvirkes også næringsopptaket.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Humørsvingninger, nedstemthet og irritabilitet  </h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig å følge med på?</strong><br/>Psykisk helse henger tett sammen med fysisk overskudd, og det er viktig å ta følelsene på alvor - spesielt når det går utover trening, skole eller hverdagsglede.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Dårlig konsentrasjon og nedsatt mental skarphet</h3> 
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Angst eller uro rundt mat og spising</h3> 
                                                                        ...
                                                                        <p><strong>Når mat skaper uro i hverdagen, er det et tegn på at noe er i ubalanse. </strong></p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Tvangspregede treningsvaner</h3> 
                                                                        ...
                                                                        <p><strong>Hvorfor er det viktig:</strong>Hvile er avgjørende for å tåle treningsbelastningen og unngå skader. Hvis trening alltid “må bli gjort”, selv når kroppen sier nei, øker risikoen for overbelastning, skader og energimangel.</p>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-12 col-md-12 col-lg-6"> 
                                                                    <div class="two-step-box-col two-step-box-img">
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Kroppsmisnøye, perfeksjonisme og lavt selvbilde</h3> 
                                                    ...
                                                    <div class="slider-box-caption-con">
                                                        <div class="slider-box-caption">
                                                            <div class="row align-items-center"> 
                                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                                    <div class="two-step-box-col two-step-box-caption allWhiteColor"> 
                                                                        <h3>Opplevde symptomer varierer fra person til person</h3> 
                                                                        ...
                                                                        <p><strong>Biologisk variasjon</strong></p>
                                                                        <ul>
                                                                            ...
                                                                            <li><spstrongan>Tidligere helsetilstand:</strong> en som har hatt spise-forstyrrelser, benskjørhet eller hormonproblemer tidligere er mer sårbar for å utvikle symptomer</li>
                                                                        </ul>
                                                                        <p><strong>Varighet og alvorlighetsgrad av energimangel</strong></p>
                                                                        <ul>
                                                                            <li><strong>Kortvarig vs. langvarig LEA:</strong> Kroppen kan tåle perioder med lav energitilgjengelighet, men over tid vil belastningen gi større risiko for symptomer</li>
                                                                            <li><strong>Individuell terskel:</strong> Noen får symptomer tidlig ved små underskudd, mens andre kan ha langvarig LEA før det gir utslag</li>
                                                                        </ul>
